    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="<?php echo site_url('store/dashboard') ?>" class="logo">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"><?php echo ucfirst($this->session->userdata('mowner')); ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            <?php echo ucfirst($this->session->userdata('mname')); ?> - <?php echo ucfirst($this->session->userdata('mowner')); ?>
                                            <small><?php echo $this->session->userdata('memail'); ?></small>
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('store/profile') ?>" class="btn btn-default btn-flat">Profile</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo site_url('store/auth/logout?location=' . htmlspecialchars($_SERVER['REQUEST_URI'])) ?>" class="btn btn-default btn-flat">Sign out</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
